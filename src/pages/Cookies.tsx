    ...
    <Layout>
        ...
        <div className="max-w-4xl mx-auto px-4 pt-8 mb-[-7rem]">
            ...
            <div className="mb-8">
                ...
                This Cookie Policy explains how Mun-E ("Company," "we," "us," and "our") uses cookies and similar 
                technologies to recognize you when you visit our website at{' '}
                <a href="https://mun-e.com" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                    https://mun-e.com
                </a>{' '}
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-700">
                Cookies set by the website owner (in this case, Mun-E) are called "first-party cookies." Cookies set by 
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Why do we use cookies?</h2>
                <p className="text-gray-700">
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">How can I control cookies?</h2>
                <p className="text-gray-700 mb-4">
                ...
                perform are described in the table below (please note that the specific cookies served may vary depending 
                on the specific Online Properties you visit).
                </p>
            </div>
            
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">How can I control cookies on my browser?</h2>
                <p className="text-gray-700 mb-4">
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">What about other tracking technologies, like web beacons?</h2>
                <p className="text-gray-700">
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Do you use Flash cookies or Local Shared Objects?</h2>
                <p className="text-gray-700 mb-4">
                ...
                being placed on your computer without your being asked, and (for Flash Player 8 and later) how to block 
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Do you serve targeted advertising?</h2>
                <p className="text-gray-700">
            ...
            {/* Policy updates */}
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">How often will you update this Cookie Policy?</h2>
                <p className="text-gray-700 mb-4">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Where can I get further information?</h2>
                <p className="text-gray-700 mb-4">
                If you have any questions about our use of cookies or other technologies, please email us at{' '}
                <a href="mailto:customercare@mun-e.com" className="text-blue-600 hover:underline">
