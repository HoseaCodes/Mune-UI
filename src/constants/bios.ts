...
export const teamMembers = [
    ...
    },
    {
      ...
      role: 'CTO',
      image: dominique,
      bio: 'Dominique Hosea is a seasoned software engineer with a strong foundation in developing maintainable and scalable web and mobile applications, particularly for enterprise-level projects. With a passion for optimizing existing systems and building efficient infrastructures, Dominiques expertise spans various domains, ensuring the delivery of high-quality and reliable solutions. Industry Experience • Backend Services • Architecture • Technology Startups',
    },
  ];