  ...
  return (
    <div className="mb-36 mt-[-88px]">
      <div className="relative w-full">
        ...
        {/* Image */}
        <Image width={0} height={0} src={missionImage} alt="Mission" className="max-w-full lg:max-w-[4184px] mx-auto mt-[40px] sm:mt-[80px] md:mt-[120px] lg:mt-[157px] rounded-[48px] border-2 border-custom-bgreen" />
